...
import board, { sliders, BigIntSignalArray, colors, charPieces, bitboards, castle, enpassant, side, unicodePieces } from "~/consts/board";
...
import { addMove, printMove, printMoveList } from "~/utils/move/move";
...
export default function Home() {
  const [moveList, setMoveList] = createSignal<MoveList>({moves: [], count: 0});
  ...
  onMount(() => {
    ...
    const newMoveList = addMove(moveList(), encodeMove(notToRawPos("d7"), notToRawPos("e8"), charPieces.P, charPieces.Q, 1, 0, 0, 0));
